  ...
  gainingSpecialAmount() {
    ...
    switch (randomTreasure) {
      case 2:
        ...
        coins += 70;
        let coinsSpec = new ShowSpecialItem(ctx, game.points.x , game.points.y - 20, 150, 80)
        game.showSpecialItems.push(coinsSpec)
        break;
      case 3:
        game.player.slowIncreaseFireElectro(700);
        let fireSpec = new ShowSpecialItem(ctx, game.player.x - 20 , game.player.y - 50, 100, 100)
        game.showSpecialItems.push(fireSpec)
        break;
      case 1:
        basicWeaponImgChange();
        basicWeaponLevel++;
        let spec = new ShowSpecialItem(ctx, CTXW - 100 , CTXH - 100, 100, 100)
