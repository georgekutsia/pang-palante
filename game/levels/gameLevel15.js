...
function level15( ctx, platforms, bubbles, levelBalls,  darkBubbles, cannons, boxes, healings, flamethrowers){
  ...
  flamethrowerItem15(ctx, flamethrowers) 
...
function addBubble15(ctx, bubbles){ 
    const bubble1 = new Bubble(ctx, CTXW/2 -150, 20, 300, 300, -0.04, -0.08, 0.000017, true, 40000)
...
function addHealings15(ctx, healings){
  ...
  function flamethrowerItem15(ctx, flamethrowers) {  
